...
const ViewDetailProduct = ({ product }: ViewDetailProductProps) => {
  ...
  const formatDate = (date?: Date) =>
    date ? new Intl.DateTimeFormat("pt-BR").format(new Date(date)) : "Não informado";
  return (
          ...
          <div className="flex-grow">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <p className="font-semibold">{supplier?.name || "Não informado"}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="font-semibold">{categories?.name || "Não informado"}</p>
              </div>
            </div>
          </div>
        </div>
